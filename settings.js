...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "CNpU3R5B#PY0CIa8C8PraYmVR07KiJTruBwculCdfqzAFD_XLPf8", // Add your session id
PREFIX: process.env.PREFIX || ".",
MODE: process.env.MODE || "public",  //public | private | inbox | group
OWNER_NUMBER: process.env.OWNER_NUMBER || "94775925332",
DEV: process.env.DEV || "94775925332",
