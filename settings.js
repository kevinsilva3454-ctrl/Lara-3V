...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "WIwXCL7D#kdagpXXAl6fEETz6sRg0cM7cPnmq6ndJMEfEwWT4P2o", // Add your session id
PREFIX: process.env.PREFIX || ".",
MODE: process.env.MODE || "public",  //public | private | inbox | group
OWNER_NUMBER: process.env.OWNER_NUMBER || "94701407138",
DEV: process.env.DEV || "94701407138",
...
CUSTOM_REACT: process.env.CUSTOM_REACT || "off",
